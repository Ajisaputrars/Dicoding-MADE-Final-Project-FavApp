...
public class FavoriteMovieWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.example.ajisaputrars.myfavoriteapp.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.ajisaputrars.myfavoriteapp.EXTRA_ITEM";
